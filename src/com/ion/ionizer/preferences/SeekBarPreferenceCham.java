...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String IONIONIZERNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, IONIONIZERNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, IONIONIZERNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(IONIONIZERNS, "interval");
            if(newInterval != null)
