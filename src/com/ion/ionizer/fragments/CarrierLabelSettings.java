...
public class CarrierLabelSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        mShowCarrierLabel.setEntries(IonUtils.hasNotch(getActivity()) ? NotchEntries : NonNotchEntries);
        mShowCarrierLabel.setEntryValues(IonUtils.hasNotch(getActivity()) ? NotchValues : NonNotchValues);
